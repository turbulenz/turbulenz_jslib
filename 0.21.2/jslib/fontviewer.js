...
//
function FontViewer() {}
FontViewer.prototype =
{
    version : 1
};

// Constructor function
FontViewer.create = function viewerCreateFn(tz, applicationSettings)
{
    ...
    vi.load = function viewerLoadFn(assetPath)
    {
        ...
        var fontdatReceived = function fontdatReceivedFn(text)
        {
            ...
            {
                Utilities.assert(false, "Texture '" + texturePath + "' not created.");
            }
        };
        ...
        tz.request(vi.pathPrefix + 'shaders/gui.cgfx',
                    function (shaderText)
                    {
                        Utilities.assert(shaderText, "Shader 'shaders/gui.cgfx' not created.");
                        ...
                        if (shaderText)
                        {
                            ...
                            Utilities.assert(s, "Shader 'shaders/gui.cgfx' not created.");
