...
//
var NetworkLatencyBehaviour = function NetworkLatencyBehaviourFn() {};

NetworkLatencyBehaviour.prototype =
{
	nextMessageDelay: function nextMessageDelayFn()
	{
	...
	scheduleNextDelay: function scheduleNextDelayFn(baseTime)
	{
...
NetworkLatencyBehaviour.create = function networkLatencyBehaviourCreate(config)
{
...
//
var NetworkLatencySimulator = function NetworkLatencySimulatorFn() {};

NetworkLatencySimulator.prototype =
{
	queueMessage: function queueMessageMessageFn(messageFunction, queueName)
	{
	...
	processMessage: function processMessageFn(queue)
	{
		if (queue.length)
		{
	...
	flushQueues: function flushQueueFn()
	{
	...
	addMultiplayerSession : function addMultiplayerSessionFn(multiplayerSession)
	{
		var that = this;
...
NetworkLatencySimulator.create = function NetworkLatencySimulatorCreateFn(behaviour)
{
