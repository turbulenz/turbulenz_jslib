/* This file was generated from TypeScript source tslib/webgl/graphicsdevice.ts */
...
TZWebGLTexture.prototype = {
                ...
                for(n = 0; n < numLevels; n += 1) {
                    if(compressedTexturesExtension) {
                        ...
                        if(bufferData) {
                            ...
                            gl.texImage2D(faceTarget, n, internalFormat, w, h, 0, internalFormat, gltype, new Uint8Array(levelSize));
                        }
                    }
                    offset += levelSize;
            ...
            for(n = 0; n < numLevels; n += 1) {
                if(compressedTexturesExtension) {
                    ...
                    if(bufferData) {
                        ...
                        gl.texImage2D(target, n, internalFormat, w, h, 0, internalFormat, gltype, new Uint8Array(levelSize));
                    }
                }
                offset += levelSize;
                w = (w > 1 ? Math.floor(w / 2) : 1);
    ...
    typedArrayIsValid: function textureTypedArrayIsValidFn(typedArray) {
        ...
        if(gd) {
            ...
            if((format === gd.PIXELFORMAT_R5G5B5A1) || (format === gd.PIXELFORMAT_R5G6B5)) {
