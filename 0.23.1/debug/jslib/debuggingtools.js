...
var DebuggingTools = {};
DebuggingTools.dataBreakpoints = [];

DebuggingTools.log = function DebuggingToolsLogFn()
{
...
DebuggingTools.dataBreakpoint = function debuggingToolsDataBreakpointFn(object, propertyName, breakOnRead, breakOnWrite)
{
	if (propertyName)
	{
...
DebuggingTools.clearDataBreakpoint = function debuggingToolsClearDataBreakpointFn(object, propertyName)
{
	var matched = false;
	var i = 0;
