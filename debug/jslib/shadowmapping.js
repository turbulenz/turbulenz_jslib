/* This file was generated from TypeScript source tslib/shadowmapping.ts */
...
var ShadowMapping = (function () {
    ...
    ShadowMapping.prototype.drawShadowMap = function (cameraMatrix, minExtentsHigh, lightInstance) {
        ...
        gd.drawArray(occludersDrawArray, [
    ...
    function create(gd, md, shaderManager, effectsManager, sizeLow, sizeHigh) {
        ...
        shadowMapping.pixelOffsetH = [
            0, 
            0
        ];
        shadowMapping.pixelOffsetV = [
            0, 
            0
        ];
