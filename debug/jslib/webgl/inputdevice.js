/* This file was generated from TypeScript source tslib/webgl/inputdevice.ts */
...
WebGLInputDevice.create = function webGLInputDeviceFn(canvas/*, params */ ) {
    ...
    if(requestPointerLock) {
        ...
        id.onPointerLockChanged = function onPointerLockChangedFn() {
            /* event */ var pointerLockElement = (document.pointerLockElement || document.mozPointerLockElement || document.webkitPointerLockElement);
            if(pointerLockElement !== id.canvas) {
                id.unlockMouse();
            }
        };
        id.onPointerLockError = function onPointerLockErrorFn() {
            /* event */ id.unlockMouse();
        };
