...
TextureEffects.prototype = {

    version : 1,

    grayScaleMatrix : function grayScaleMatrix(dst)
    {
        if (dst === undefined)
        {
    ...
    sepiaMatrix : function sepiaMatrix(dst)
    {
        if (dst === undefined)
        {
            dst = this.mathDevice.m43BuildIdentity();
    ...
    negativeMatrix : function negativeMatrix(dst)
    {
        if (dst === undefined)
        {
            dst = this.mathDevice.m43BuildIdentity();
    ...
    saturationMatrix : function saturationMatrix(saturationScale, dst)
    {
        if (dst === undefined)
        {
            dst = this.mathDevice.m43BuildIdentity();
    ...
    hueMatrix : function hueMatrix(angle, dst)
    {
        if (dst === undefined)
        {
            dst = this.mathDevice.m43BuildIdentity();
    ...
    brightnessMatrix : function brightnessMatrixFn(brightnessOffset, dst)
    {
        if (dst === undefined)
        {
            dst = this.mathDevice.m43BuildIdentity();
    ...
    contrastMatrix : function contrastMatrixFn(contrastScale, dst)
    {
        if (dst === undefined)
        {
            dst = this.mathDevice.m43BuildIdentity();
    ...
    applyBloom : function bloomFn(params)
    {
    ...
    applyGaussianBlur : function applyBlurFn(params)
    {
        var source = params.source;
    ...
    applyColorMatrix : function colorMatrixFn(params)
    {
        var source = params.source;
        var dest = params.destination;
        if (!source || !dest ||
    ...
    applyDistort : function distortFn(params)
    {
        var source = params.source;
        var dest = params.destination;
    ...
    applyEffect : function effectFn(effect)
    {
        ...
        if (graphicsDevice.beginRenderTarget(dest))
        {
            ...
            graphicsDevice.endRenderTarget(dest);
        }
    },
    ...
    destroy : function destroyFn()
    {
        ...
        delete this.mathsDevice;
    }

};

TextureEffects.create = function draw2DEffectsFn(params)
{
