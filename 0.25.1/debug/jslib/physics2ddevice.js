...
var Physics2DConfig = {
    ...
    // Percentage of error solved per-iteration
    0.5,
    ANGLE_SLOP_SQ: 0.000001,
    DIST_BIAS_COEF: // rad^2
    // Distance
    // --------
    // Percentage of error solved per-iteration
    0.5,
    DIST_SLOP_SQ: 0.000001,
    ...
    // (General)
    0.00001,
    COLLINEAR_SQ_EPSILON: (0.00001 * 0.00001),
    NORMALIZE_EPSILON: 0.000001,
    NORMALIZE_SQ_EPSILON: (0.000001 * 0.000001),
    ...
    Physics2DCustomConstraint.prototype._iterateVel = function () {
        ...
        for(i = 0; i < dimension; i += 1) {
            ...
            for(j = 0; j < limit2; j += 1) {
                ...
                term -= ((body[(7)] * data[JAC]) + (body[/*BODY_VEL*/ (7) + 1] * data[JAC + 1]) + (body[/*BODY_VEL*/ (7) + 2] * data[JAC + 2]));
                JAC += 3;
            }
            data[VECTOR + i] = term;
        }
...
var Physics2DPulleyConstraint = (function (_super) {
    ...
    Physics2DPulleyConstraint.prototype._preStep = function (deltaTime) {
        ...
        var cx1 = data[(33)] = ((data[(19)] * n12y) - (data[/*PULLEY_RANCHOR1*/ (19) + 1] * n12x));
        var cx2 = data[(34)] = ((data[(21)] * n12y) - (data[/*PULLEY_RANCHOR2*/ (21) + 1] * n12x));
        var cx3 = data[(35)] = ((data[(23)] * n34y) - (data[/*PULLEY_RANCHOR3*/ (23) + 1] * n34x));
        var cx4 = data[(36)] = ((data[(25)] * n34y) - (data[/*PULLEY_RANCHOR4*/ (25) + 1] * n34x));
        var im3 = b3[(0)];
        var ii3 = b3[(1)];
    ...
    Physics2DPulleyConstraint.prototype._warmStart = function () {
        ...
        b1[/*BODY_VEL*/ (7) + 2] -= (data[(33)] * jAcc * b1[(1)]);
        im = b2[(0)];
        b2[(7)] += (jx * im);
        b2[/*BODY_VEL*/ (7) + 1] += (jy * im);
        b2[/*BODY_VEL*/ (7) + 2] += (data[(34)] * jAcc * b2[(1)]);
        jx = (data[(31)] * jAcc);
        jy = (data[/*PULLEY_N34*/ (31) + 1] * jAcc);
        im = b3[(0)];
        b3[(7)] -= (jx * im);
        b3[/*BODY_VEL*/ (7) + 1] -= (jy * im);
        b3[/*BODY_VEL*/ (7) + 2] -= (data[(35)] * jAcc * b3[(1)]);
        im = b4[(0)];
        b4[(7)] += (jx * im);
        b4[/*BODY_VEL*/ (7) + 1] += (jy * im);
        b4[/*BODY_VEL*/ (7) + 2] += (data[(36)] * jAcc * b4[(1)]);
    };
    ...
    Physics2DPulleyConstraint.prototype._iterateVel = function () {
        ...
        var cx3 = data[(35)];
        var cx4 = data[(36)];
        var x = (data[(28)] - ((n12x * (b2[(7)] - b1[(7)])) + (n12y * (b2[/*BODY_VEL*/ (7) + 1] - b1[/*BODY_VEL*/ (7) + 1])) + (n34x * (b4[(7)] - b3[(7)])) + (n34y * (b4[/*BODY_VEL*/ (7) + 1] - b3[/*BODY_VEL*/ (7) + 1])) + (cx2 * b2[/*BODY_VEL*/ (7) + 2]) - (cx1 * b1[/*BODY_VEL*/ (7) + 2]) + (cx4 * b4[/*BODY_VEL*/ (7) + 2]) - (cx3 * b3[/*BODY_VEL*/ (7) + 2])));
        var jOld = data[(9)];
        // Impulse.
        // j = K * x - jAcc * gamma
        ...
        b1[(7)] -= (jx * im);
        b1[/*BODY_VEL*/ (7) + 1] -= (jy * im);
        b1[/*BODY_VEL*/ (7) + 2] -= (cx1 * j * b1[(1)]);
        im = b2[(0)];
        b2[(7)] += (jx * im);
        b2[/*BODY_VEL*/ (7) + 1] += (jy * im);
        b2[/*BODY_VEL*/ (7) + 2] += (cx2 * j * b2[(1)]);
        jx = (data[(31)] * j);
        jy = (data[/*PULLEY_N34*/ (31) + 1] * j);
        im = b3[(0)];
        b3[(7)] -= (jx * im);
        b3[/*BODY_VEL*/ (7) + 1] -= (jy * im);
        b3[/*BODY_VEL*/ (7) + 2] -= (cx3 * j * b3[(1)]);
        im = b4[(0)];
        b4[(7)] += (jx * im);
        b4[/*BODY_VEL*/ (7) + 1] += (jy * im);
        b4[/*BODY_VEL*/ (7) + 2] += (cx4 * j * b4[(1)]);
        return false;
    };
    Physics2DPulleyConstraint.prototype._iteratePos = function () {
        ...
        var cx1 = ((data[(19)] * n12y) - (data[/*PULLEY_RANCHOR1*/ (19) + 1] * n12x));
        var cx2 = ((data[(21)] * n12y) - (data[/*PULLEY_RANCHOR2*/ (21) + 1] * n12x));
        var cx3 = ((data[(23)] * n34y) - (data[/*PULLEY_RANCHOR3*/ (23) + 1] * n34x));
        var cx4 = ((data[(25)] * n34y) - (data[/*PULLEY_RANCHOR4*/ (25) + 1] * n34x));
...
var Physics2DMotorConstraint = (function (_super) {
    ...
    Physics2DMotorConstraint.prototype._warmStart = function () {
        ...
        var b2 = this.bodyB._data;
        var j = data[(8)];
        b1[/*BODY_VEL*/ (7) + 2] -= (j * b1[(1)]);
        b2[/*BODY_VEL*/ (7) + 2] += (data[(6)] * j * b2[(1)]);
    };
    ...
    Physics2DMotorConstraint.prototype._iterateVel = function () {
        ...
        var b2 = this.bodyB._data;
        var ratio = data[(6)];
        var j = (data[(7)] * (data[(5)] + b1[/*BODY_VEL*/ (7) + 2] - (ratio * b2[/*BODY_VEL*/ (7) + 2])));
        var jOld = data[(8)];
        var jAcc = (jOld + j);
        var jMax = data[(9)];
...
var Physics2DLineConstraint = (function (_super) {
    ...
    Physics2DLineConstraint.prototype.setAxis = function (axis) {
        ...
        var newX = axis[0];
        var newY = axis[1];
        if(newX !== data[(11)] || newY !== data[/*LINE_LAXIS*/ (11) + 1]) {
    ...
    Physics2DLineConstraint.prototype._posError = function () {
        ...
        var dy = data[(29)] = ((b2[/*BODY_POS*/ (2) + 1] + ry2) - (b1[/*BODY_POS*/ (2) + 1] + ry1));
    ...
    Physics2DLineConstraint.prototype._warmStart = function () {
        ...
        b1[/*BODY_VEL*/ (7) + 2] += (((scale * data[(28)] * jy) - (data[(30)] * jx)) * b1[(1)]);
        im = b2[(0)];
        b2[(7)] += (lx * im);
        b2[/*BODY_VEL*/ (7) + 1] += (ly * im);
        b2[/*BODY_VEL*/ (7) + 2] += (((data[(31)] * jx) - (scale * data[(29)] * jy)) * b2[(1)]);
    };
    ...
    Physics2DLineConstraint.prototype._iterateVel = function () {
        ...
        b1[(7)] -= (lx * im);
        b1[/*BODY_VEL*/ (7) + 1] -= (ly * im);
        b1[/*BODY_VEL*/ (7) + 2] += (((scale * cx1 * jy) - (dot1 * jx)) * b1[(1)]);
        im = b2[(0)];
        b2[(7)] += (lx * im);
        b2[/*BODY_VEL*/ (7) + 1] += (ly * im);
        b2[/*BODY_VEL*/ (7) + 2] += (((dot2 * jx) - (scale * cx2 * jy)) * b2[(1)]);
        return false;
    };
...
var Physics2DDistanceConstraint = (function (_super) {
    ...
    Physics2DDistanceConstraint.prototype._preStep = function (deltaTime) {
        ...
        var cx1 = data[(22)] = ((data[(11)] * ny) - (data[/*DIST_RANCHOR1*/ (11) + 1] * nx));
        var cx2 = data[(23)] = ((data[(13)] * ny) - (data[/*DIST_RANCHOR2*/ (13) + 1] * nx));
    ...
    Physics2DDistanceConstraint.prototype._warmStart = function () {
        ...
        b1[(7)] -= (jx * im);
        b1[/*BODY_VEL*/ (7) + 1] -= (jy * im);
        b1[/*BODY_VEL*/ (7) + 2] -= (data[(22)] * jAcc * b1[(1)]);
        im = b2[(0)];
        b2[(7)] += (jx * im);
        b2[/*BODY_VEL*/ (7) + 1] += (jy * im);
        b2[/*BODY_VEL*/ (7) + 2] += (data[(23)] * jAcc * b2[(1)]);
    };
    ...
    Physics2DDistanceConstraint.prototype._iterateVel = function () {
        ...
        var cx1 = data[(22)];
        var cx2 = data[(23)];
        var x = (data[(19)] - ((nx * (b2[(7)] - b1[(7)])) + (ny * (b2[/*BODY_VEL*/ (7) + 1] - b1[/*BODY_VEL*/ (7) + 1])) + (cx2 * b2[/*BODY_VEL*/ (7) + 2]) - (cx1 * b1[/*BODY_VEL*/ (7) + 2])));
        var jOld = data[(16)];
        // Impulse.
        // j = K * x - Jacc * gamma
        ...
        b1[(7)] -= (jx * im);
        b1[/*BODY_VEL*/ (7) + 1] -= (jy * im);
        b1[/*BODY_VEL*/ (7) + 2] -= (data[(22)] * j * b1[(1)]);
        im = b2[(0)];
        b2[(7)] += (jx * im);
        b2[/*BODY_VEL*/ (7) + 1] += (jy * im);
        b2[/*BODY_VEL*/ (7) + 2] += (data[(23)] * j * b2[(1)]);
        return false;
    };
    Physics2DDistanceConstraint.prototype._iteratePos = function () {
        ...
        var cx1 = ((data[(11)] * ny) - (data[/*DIST_RANCHOR1*/ (11) + 1] * nx));
        var cx2 = ((data[(13)] * ny) - (data[/*DIST_RANCHOR2*/ (13) + 1] * nx));
...
var Physics2DAngleConstraint = (function (_super) {
    ...
    Physics2DAngleConstraint.prototype._iterateVel = function () {
        ...
        var scale = data[(13)];
        var ratio = data[(7)];
        var x = (data[(12)] - (scale * ((ratio * b2[/*BODY_VEL*/ (7) + 2]) - b1[/*BODY_VEL*/ (7) + 2])));
        var jOld = data[(9)];
        // Impulse.
        // j = K * x - Jacc * gamma
...
var Physics2DWeldConstraint = (function (_super) {
    ...
    Physics2DWeldConstraint.prototype._preStep = function (deltaTime) {
        ...
        if(!this._stiff) {
            ...
            data[/*WELD_BIAS*/ (25) + 2] = ((b1[/*BODY_POS*/ (2) + 2] + data[(13)]) - b2[/*BODY_POS*/ (2) + 2]);
    ...
    Physics2DWeldConstraint.prototype._warmStart = function () {
        ...
        b1[(7)] -= (jx * im);
        b1[/*BODY_VEL*/ (7) + 1] -= (jy * im);
        b1[/*BODY_VEL*/ (7) + 2] -= (((data[(9)] * jy) - (data[/*WELD_RANCHOR1*/ (9) + 1] * jx) + jz) * b1[(1)]);
        im = b2[(0)];
        b2[(7)] += (jx * im);
        b2[/*BODY_VEL*/ (7) + 1] += (jy * im);
        b2[/*BODY_VEL*/ (7) + 2] += (((data[(11)] * jy) - (data[/*WELD_RANCHOR2*/ (11) + 1] * jx) + jz) * b2[(1)]);
    };
    Physics2DWeldConstraint.prototype.getImpulseForBody = function (body, dst) {
        ...
        if(body === this.bodyA) {
            dst[0] = -jx;
            dst[1] = -jy;
            dst[2] = -((data[(9)] * jy) - (data[/*WELD_RANCHOR1*/ (9) + 1] * jx) + jz);
        } else if(body === this.bodyB) {
            dst[0] = jx;
            dst[1] = jy;
            dst[2] = ((data[(11)] * jy) - (data[/*WELD_RANCHOR2*/ (11) + 1] * jx) + jz);
        } else {
            dst[0] = dst[1] = dst[2] = 0;
        }
        return dst;
    ...
    Physics2DWeldConstraint.prototype._iterateVel = function () {
        ...
        b1[(7)] -= (jx * im);
        b1[/*BODY_VEL*/ (7) + 1] -= (jy * im);
        b1[/*BODY_VEL*/ (7) + 2] -= (((rx1 * jy) - (ry1 * jx) + jz) * b1[(1)]);
        im = b2[(0)];
        b2[(7)] += (jx * im);
        b2[/*BODY_VEL*/ (7) + 1] += (jy * im);
        b2[/*BODY_VEL*/ (7) + 2] += (((rx2 * jy) - (ry2 * jx) + jz) * b2[(1)]);
        return false;
    };
    Physics2DWeldConstraint.prototype._iteratePos = function () {
        ...
        var errZ = ((b1[/*BODY_POS*/ (2) + 2] + data[(13)]) - b2[/*BODY_POS*/ (2) + 2]);
        var elsq = ((errX * errX) + (errY * errY));
        var wlsq = (errZ * errZ);
        var maxError = data[(3)];
...
var Physics2DPointConstraint = (function (_super) {
    ...
    Physics2DPointConstraint.prototype._warmStart = function () {
        ...
        b1[(7)] -= (jx * im);
        b1[/*BODY_VEL*/ (7) + 1] -= (jy * im);
        b1[/*BODY_VEL*/ (7) + 2] -= (((data[(9)] * jy) - (data[/*POINT_RANCHOR1*/ (9) + 1] * jx)) * b1[(1)]);
        im = b2[(0)];
        b2[(7)] += (jx * im);
        b2[/*BODY_VEL*/ (7) + 1] += (jy * im);
        b2[/*BODY_VEL*/ (7) + 2] += (((data[(11)] * jy) - (data[/*POINT_RANCHOR2*/ (11) + 1] * jx)) * b2[(1)]);
    };
    Physics2DPointConstraint.prototype.getImpulseForBody = function (body, dst) {
        ...
        if(body === this.bodyA) {
            dst[0] = -jx;
            dst[1] = -jy;
            dst[2] = -((data[(9)] * jy) - (data[/*WELD_RANCHOR1*/ (9) + 1] * jx));
        } else if(body === this.bodyB) {
            dst[0] = jx;
            dst[1] = jy;
            dst[2] = ((data[(11)] * jy) - (data[/*WELD_RANCHOR2*/ (11) + 1] * jx));
        } else {
            dst[0] = dst[1] = dst[2] = 0;
        }
        return dst;
    ...
    Physics2DPointConstraint.prototype._iterateVel = function () {
        ...
        b1[(7)] -= (jx * im);
        b1[/*BODY_VEL*/ (7) + 1] -= (jy * im);
        b1[/*BODY_VEL*/ (7) + 2] -= (((rx1 * jy) - (ry1 * jx)) * b1[(1)]);
        im = b2[(0)];
        b2[(7)] += (jx * im);
        b2[/*BODY_VEL*/ (7) + 1] += (jy * im);
        b2[/*BODY_VEL*/ (7) + 2] += (((rx2 * jy) - (ry2 * jx)) * b2[(1)]);
        return false;
    };
...
var Physics2DCircle = (function (_super) {
    ...
    Physics2DCircle.prototype.setOrigin = function (origin) {
        ...
        if(data[(7)] !== originX || data[/*CIRCLE_LOCAL*/ (7) + 1] !== originY) {
            data[(7)] = originX;
...
var Physics2DPolygon = (function (_super) {
    ...
    Physics2DPolygon.prototype._validate = function (vertices) {
        ...
        var newLimit = /*POLY_VERTICES*/ (6) + (vCount * (13));
...
var Physics2DRigidBody = (function () {
    ...
    Physics2DRigidBody.prototype.setAsStatic = function () {
        ...
        data[(7)] = data[/*BODY_VEL*/ (7) + 1] = data[/*BODY_VEL*/ (7) + 2] = 0;
    };
    ...
    function (impulse, position) {
        ...
        data[/*BODY_VEL*/ (7) + 2] += (((x * iy) - (y * ix)) * data[(1)]);
        this.wake(true);
    };
    ...
    Physics2DRigidBody.prototype.setPosition = function (position) {
        ...
        var newX = position[0];
        var newY = position[1];
        if((data[(2)] !== newX) || (data[/*BODY_POS*/ (2) + 1] !== newY)) {
            data[(2)] = newX;
    ...
    Physics2DRigidBody.prototype.setVelocity = function (velocity) {
        ...
        var newX = velocity[0];
        var newY = velocity[1];
        if((data[(7)] !== newX) || (data[/*BODY_VEL*/ (7) + 1] !== newY)) {
            data[(7)] = newX;
    ...
    Physics2DRigidBody.prototype.setForce = function (force) {
        ...
        var newX = force[0];
        var newY = force[1];
        if((data[(10)] !== newX) || (data[/*BODY_FORCE*/ (10) + 1] !== newY)) {
            data[(10)] = newX;
    ...
    Physics2DRigidBody.prototype._update = function () {
        if(this._invalidated) {
            ...
            var i;
            for(i = 0; i < limit; i += 1) {
                shapes[i]._update(data[(2)], data[/*BODY_POS*/ (2) + 1], data[(5)], data[/*BODY_AXIS*/ (5) + 1]);
            }
        }
    };
...
var Physics2DArbiter = (function () {
    ...
    function () {
        ...
        data1[/*BODY_VEL*/ (7) + 2] -= ((cdata[(7)] * jy) - (cdata[/*CON_REL1*/ (7) + 1] * jx)) * ii1;
        data2[(7)] += (jx * im2);
        data2[/*BODY_VEL*/ (7) + 1] += (jy * im2);
        data2[/*BODY_VEL*/ (7) + 2] += ((cdata[(9)] * jy) - (cdata[/*CON_REL2*/ (9) + 1] * jx)) * ii2;
        if(this._velocity2Contact) {
    ...
    Physics2DArbiter.prototype.getImpulseForBody = function (body, dst) {
        ...
        if(body === this.bodyA) {
            sumX -= jx;
            sumY -= jy;
            sumW -= ((cdata[(7)] * jy) - (cdata[/*CON_REL1*/ (7) + 1] * jx));
        } else if(body === this.bodyB) {
            sumX += jx;
            sumY += jy;
            sumW += ((cdata[(9)] * jy) - (cdata[/*CON_REL2*/ (9) + 1] * jx));
        }
        if(this._velocity2Contact) {
            cdata = this._contact2._data;
            jn = cdata[(11)];
...
var Physics2DWorld = (function () {
    ...
    Physics2DWorld.prototype.convexCast = function (shape, deltaTime, customCallback, thisObject) {
        ...
        shape._update(preX, preY, bdata[(5)], bdata[/*BODY_AXIS*/ (5) + 1], true);
        if(callback.minShape) {
        ...
        if(first || arb._timeStamp !== this.timeStamp || continuous) {
            ...
            if((ctype && this._collisions._collide(sa, sb, arb)) || (!ctype && this._collisions._test(sa, sb))) {
                ...
                if(first || (arb._endGenerated === this.timeStamp && continuous) || (arb._updateStamp < (this.timeStamp - 1))) {
                    ...
                    /*jshint bitwise: false*/
                    arb._state = (ctype ? 0 : (/*STATE_ACCEPT*/ (1) | (2)));
                    /*jshint bitwise: true*/
                                    }
                ...
                /*jshint bitwise: false*/
                if(ctype && (arb._state & (2)) === 0)/*jshint bitwise: true*/
                 {
                    ...
                    /*jshint bitwise: false*/
                    if(anyIndeterminate && (arb._state & (2)) === 0)/*jshint bitwise: true*/
                     {
    ...
    function (deltaTime) {
        ...
        while(curTimeAlpha < 1.0 && limit !== 0) {
            ...
            if(!b1._sweepFrozen || toi.kinematic) {
                ...
                s1._update(data1[(2)], data1[/*BODY_POS*/ (2) + 1], data1[(5)], data1[/*BODY_AXIS*/ (5) + 1], true);
            }
            if(!b2._sweepFrozen || toi.kinematic) {
                b2._sweepIntegrate(curTimeAlpha * deltaTime);
                s2._update(data2[(2)], data2[/*BODY_POS*/ (2) + 1], data2[(5)], data2[/*BODY_AXIS*/ (5) + 1], true);
            }
            ...
            /*jshint bitwise: false*/
            if(arb && !arb.sensor && (arb._state & (1)) !== 0)/*jshint bitwise: true*/
             {
                // Freeze objects
    ...
    function (arb, deltaTime, progressEvents) {
        ...
        if(arb.active) {
            /*jshint bitwise: false*/
            if((arb._state & (1)) !== 0)/*jshint bitwise: true*/
             {
    ...
    Physics2DWorld.prototype._iterateVelocityArbiters = function (arbiters) {
        ...
        for(i = 0; i < limit; i += 1) {
            var arb = arbiters[i];
            /*jshint bitwise: false*/
            if(arb.active && !arb.sensor && (arb._state & (1)) !== 0)/*jshint bitwise: true*/
             {
    ...
    function (deltaTime) {
        ...
        for(i = 0; i < limit; i += 1) {
            ...
            if(iinertia !== 0) {
                ...
                data[/*BODY_VEL*/ (7) + 2] *= Math.exp(deltaTime * data[(22)]);
            }
        }
    };
    ...
    Physics2DWorld.prototype._finalizeBodies = function (bodies) {
        ...
        for(i = 0; i < limit; ) {
            ...
            var limit2 = shapes.length;
            var j, shape;
            if(data[(15)] !== data[(2)] || data[/*BODY_PRE_POS*/ (15) + 1] !== data[/*BODY_POS*/ (2) + 1] || data[/*BODY_PRE_POS*/ (15) + 2] !== data[/*BODY_POS*/ (2) + 2]) {
    ...
    Physics2DWorld.prototype._wakeArbiters = function (arbiters, skip, continuousCallbacks) {
        ...
        for(i = 0; i < limit; i += 1) {
            ...
            if(!skip) {
                ...
                /*jshint bitwise: false*/
                if((arb._updateStamp === timeStamp) && !arb.sensor && (arb._state & (1)) !== 0)/*jshint bitwise: true*/
                 {
                    var b1 = arb.bodyA;
                    var b2 = arb.bodyB;
...
var Physics2DCollisionUtils = (function () {
    ...
    Physics2DCollisionUtils.prototype.sweepTest = function (shapeA, shapeB, deltaTime, point, normal) {
        ...
        dataA[(18)] = 0;
        dataB[(18)] = 0;
        dataA[(20)] = (dataA[/*BODY_VEL*/ (7) + 2]);
        dataB[(20)] = (dataB[/*BODY_VEL*/ (7) + 2]);
        var ret = this._dynamicSweep(toi, deltaTime, 0, true);
        bodyA._sweepIntegrate(0);
        bodyB._sweepIntegrate(0);
        shapeA._update(dataA[(2)], dataA[/*BODY_POS*/ (2) + 1], dataA[(5)], dataA[/*BODY_AXIS*/ (5) + 1]);
        shapeB._update(dataB[(2)], dataB[/*BODY_POS*/ (2) + 1], dataB[(5)], dataB[/*BODY_AXIS*/ (5) + 1]);
        if(ret < 0) {
            return undefined;
        }
        var data = toi._data;
    ...
    function (toi, timeStep, negRadius, slowSweep) {
        ...
        while(true) {
            ...
            s1._update(posX, posY, data1[(5)], data1[/*BODY_AXIS*/ (5) + 1], true);
            posX = data2[(2)];
            posY = data2[/*BODY_POS*/ (2) + 1];
            s2._update(posX, posY, data2[(5)], data2[/*BODY_AXIS*/ (5) + 1], true);
    ...
    Physics2DCollisionUtils.prototype._collideCircle2Polygon = function (circle, polygon, arb, reverse) {
        ...
        if(proj >= dataP[edge + (10)]) {
            if(proj <= dataP[edge + (11)]) {
                ...
                adata[/*ARB_LNORM*/ (11) + 1] = dataP[edge + (4) + 1];
    ...
    Physics2DCollisionUtils.prototype._collidePolygon2Polygon = function (polyA, polyB, arb) {
        ...
        adata[/*ARB_LNORM*/ (11) + 1] = dataA[edge + (4) + 1];
