...
AssetCache.prototype =
{
    ...
    exists: function existsAssetCacheFn(key)
    {
        return this.cache.hasOwnProperty(key);
    },

    isLoading: function isLoadingAssetCacheFn(key)
    {
    ...
    request: function requestAssetCacheFn(key, params)
    {
        if (!key)
        {
            return null;
...
AssetCache.create = function assetCacheCreateFn(cacheParams)
{
